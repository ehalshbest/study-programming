...
module.exports = {
  ...
  options: {
    ...
    defaultLng: 'ko-KR',
    lngs: ['ko-KR', 'en-US', 'zh-TW'],
    func: {
      list: ['i18next.t', 'i18n.t', '$i18n.t', '$i18next.t', 'i18nextScanKey', '_t'],
      extensions: ['.js', '.jsx'],
    },
    trans: {
      component: 'Trans',
    ...
    resource: {
      ...
      // loadPath: path.join(__dirname, '/src/_Locale2/{{ns}}/{{lng}}.json'),
      // savePath: path.join(__dirname, '/src/_Locale2/{{ns}}/{{lng}}.json'),
    },
